/**
 * Solo PAX Index Data for 2024
 * Based on official SCCA Solo rules and solotime.info data
 */
...
const streetTouringClasses: SoloClassGroup = {
	...
	classes: [
		{ code: 'STR', name: 'Street Touring R', paxIndex: 0.824, isActive: true },
		{ code: 'STS', name: 'Street Touring S', paxIndex: 0.809, isActive: true },
		{ code: 'STU', name: 'Street Touring U', paxIndex: 0.830, isActive: true },
		{ code: 'STX', name: 'Street Touring X', paxIndex: 0.814, isActive: true },
		{ code: 'STH', name: 'Street Touring H', paxIndex: 0.810, isActive: true }
	]
};
...
const streetPreparedClasses: SoloClassGroup = {
	...
	classes: [
		...
		{ code: 'ASP', name: 'A Street Prepared', paxIndex: 0.857, isActive: true },
		{ code: 'BSP', name: 'B Street Prepared', paxIndex: 0.847, isActive: true },
...
const supplementalClasses: SoloClassGroup = {
	...
	classes: [
		{ code: 'XS', name: 'Xtreme Street', paxIndex: 0.867, isActive: true },
